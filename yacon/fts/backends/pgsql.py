...
from yacon.fts.backends.base import InvalidFtsBackendError
from yacon.fts.backends.base import BaseClass, BaseModel, BaseManager, BaseQueryset
...
add_introspection_rules([], ["^yacon\.fts\.backends\.pgsql\._VectorField"])
