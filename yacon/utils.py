...
class SummarizedPage(object):
    ...
    This is done as an object so that it can be used inside of the
    ``summarize_pages`` tag with the content accessed via a property.
    """

    def __init__(self, page, block_key, summary_size):
        self.page = page
