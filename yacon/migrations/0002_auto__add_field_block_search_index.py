...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Block.search_index'
        db.add_column('yacon_block', 'search_index',
                      self.gf('yacon.fts.backends.pgsql._VectorField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Block.search_index'
        db.delete_column('yacon_block', 'search_index')
