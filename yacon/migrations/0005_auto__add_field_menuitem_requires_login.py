...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.requires_login'
        db.add_column('yacon_menuitem', 'requires_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuItem.requires_login'
        db.delete_column('yacon_menuitem', 'requires_login')
